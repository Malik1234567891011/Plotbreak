...
export const WRITER_POLICY_FR = [
  ...
  '',
  'LA PLUPART DES PARAGRAPHES DISENT CE QUI SE PASSE. Quelques-uns disent ce que ça fait. Très peu disent',
  'ce que ça veut dire, et ceux-là, le beat les a mérités. Une chute sur la montagne qui observe, la mer',
  'qui défie, l’horizon qui vaut pour la liberté : excellent une fois, une manie vingt fois. Préfère la',
  'vie physique ordinaire du monde — courir, tomber, manger, voler, les genoux écorchés, les blagues',
  'idiotes, les disputes, être à bout de souffle.',
  '',
