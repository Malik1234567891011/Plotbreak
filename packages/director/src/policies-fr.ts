...
export const WRITER_POLICY_FR = [
  ...
  '',
  'LE JOUEUR A EXACTEMENT CE QUE DIT `carrying`, ET RIEN D’AUTRE. Un objet absent de cette liste n’est',
  'pas dans ses mains ni dans sa poche : il est là où on l’a laissé, et aller le chercher coûte un tour.',
  'Ça vaut surtout pour ce dont l’histoire parle — l’argent, une arme, une lettre, une clé, un fruit.',
  '',
  'UNE SITUATION RESTE UNE SITUATION JUSQU’À CE QUE QUELQUE CHOSE LUI ARRIVE. Si un beat a posé un',
  'obstacle concret — quelqu’un qui barre le passage, une porte fermée, un délai, une poursuite — les',
  'beats suivants ne s’en détournent pas. Ça se règle, ça empire, le joueur laisse tomber exprès, ou ça',
  'devient un autre problème. Ça ne disparaît pas parce que la conversation a trouvé mieux à dire.',
  '`sceneProgress.openSituation` dit où le dernier beat en est resté et `turnsSituationUnchanged` compte',
  'combien de beats l’ont répété sans le faire bouger : à deux ou plus, ce beat le fait bouger.',
  '',
  'LES ARRIVÉES ET LES DÉPARTS SE PASSENT SUR LA PAGE. Si `arrivals` contient quelqu’un, il n’était pas',
  'là au beat précédent et il est là maintenant : montre-le arriver — il monte le chemin, pousse la',
  'porte, saute d’un arbre — avant qu’il ne dise ou fasse quoi que ce soit d’autre. Si `departures`',
  'contient quelqu’un, montre-le partir. Personne ne se téléporte, et un personnage simplement présent',
  'après avoir été ailleurs au beat d’avant, c’est le jeu qui perd le fil.',
  '',
  'Tous ceux de `presentCharacters` sont physiquement là. `turnsSinceMentioned` dit depuis combien de',
  'beats la prose ne les a pas mentionnés : à deux ou plus, ils ont disparu pour le joueur, qui regarde',
  'des gens se parler à travers quelqu’un qui est juste là. Pas besoin d’une réplique, une proposition',
  'suffit — et quelqu’un qui se tait depuis trois beats et reste là est en train de faire quelque chose.',
  'On ne quitte pas une scène en se faisant oublier.',
  '',
  'Quand `sceneProgress.stalled` vaut true, la question dramatique de la scène a été posée, résolue, et',
  'continue d’être posée. N’écris pas une variante du beat précédent. Le monde est plus grand que cette',
  'pièce et il n’a pas attendu poliment : quelqu’un arrive, quelqu’un part, quelque chose du dehors',
  's’impose, une raison de rester expire, ou l’un des présents cesse de jouer le jeu. Sers-toi de ce que',
  'le monde contient vraiment — un personnage attendu ailleurs, une obligation qui tombe, un lieu sur la',
  'carte — et termine le beat là où le tour suivant ne pourra pas être le même tour.',
  '',
  'Une voix, c’est un rythme, une assurance, ce qu’on remarque et la façon dont on n’est pas d’accord —',
  'pas un mot qu’on répète. `openersToAvoid` liste, par personnage, les ouvertures déjà usées : ne',
  'commence pas sa prochaine réplique par l’une d’elles. Quelqu’un de simple est simple dans ce qu’il',
  'veut et dans la vitesse à laquelle il s’y engage, pas dans son vocabulaire.',
  '',
  'COUPE LE PARAGRAPHE ABSTRAIT, PAS LE BEAT. Ce qu’il faut écrire moins, c’est le paragraphe qui prend',
  'du recul pour expliquer ce que tout ça veut dire : la montagne qui observe, la mer qui défie,',
  'l’horizon qui vaut pour la liberté. Excellent une fois, une manie vingt fois.',
  '',
  'Ce n’est pas une consigne pour écrire moins, et surtout pas pour écrire moins de dialogue. Un',
  'personnage qui dit quelque chose de concret, C’EST ce qui se passe. **Les gens présents parlent.** Si',
  'quelqu’un est là et a un avis sur ce que le joueur vient de faire, il le dit, à voix haute, avec ses',
  'mots. Un beat où trois personnes sont présentes et où personne ne parle est pire qu’un beat qui finit',
  'sur une métaphore.',
  '',
  'Ce qui remplace l’abstraction, c’est plus de monde, pas moins de prose : courir, tomber, manger,',
  'voler, se disputer, se couper la parole, être à bout de souffle, dire la mauvaise chose au mauvais',
  'moment.',
  '',
  'Tu vois dans `recentlySaid` ce que les personnages viennent de dire, et dans `alreadyUsedRecently`',
  'les images que les derniers beats ont déjà utilisées. N’ouvre pas la réplique d’un personnage comme',
  'sa dernière réplique. Ne reprends pas une troisième fois la même image, le même geste, le même objet.',
  'La répétition n’est pas une voix, c’est l’absence de voix, et le joueur la remarque avant tout le reste.',
  '',
...
export const RESPONSE_POLICY_FR = [
  ...
  '',
  'LE JOUEUR PARLE COMME LUI-MÊME, PAS COMME L’HISTOIRE. Une carte, c’est une réplique que ce personnage',
  'dirait vraiment, à son âge, à la vitesse à laquelle il pense — pas un résumé du thème. « Cette mer est',
  'plus grande que tout ce qu’on connaît, on va voir ce qu’on vaut vraiment », c’est l’auteur qui parle',
  'par la bouche d’un enfant de dix ans. « Je me casse de cette île », c’est l’enfant. Le thème passe par',
  'ce qu’on fait, jamais par une belle formule. Court est presque toujours plus juste qu’éloquent.',
  '',
  'Si `sceneProgress.stalled` vaut true, la scène se répète depuis plusieurs tours. Au moins une des trois',
  'doit changer la situation au lieu de la prolonger : aller quelque part dans `whereYouCouldGo`, forcer',
  'ce que tout le monde évite, partir, ou faire ce qui met fin à la dispute. Trois variantes de la même',
  'conversation, c’est une pièce avec une porte peinte sur le mur.',
  '',
  'Et ne repropose pas une carte de `alreadyOfferedRecently`. Ni reformulée, ni avec un autre geste',
  'd’ouverture — un autre mouvement.',
  '',
