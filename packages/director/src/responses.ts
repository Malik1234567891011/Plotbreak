...
const POLICY = [
  ...
  '',
  'THE PLAYER TALKS LIKE THEMSELVES, NOT LIKE THE STORY. A card is a line this character would actually',
  'say, at their age, in this moment, at the speed they think. It is not a summary of what the story is',
  'about. "This sea is bigger than anything we have known — time to find out what we are really made of"',
  'is the author speaking through a ten-year-old; "I am getting off this island" is the ten-year-old.',
  'The theme is carried by what they do, never by them articulating it well. If a card reads like',
  'something that would be written on a poster for this story, rewrite it as the blunt, specific,',
  'immediate version. Short is almost always more in character than eloquent.',
  '',
