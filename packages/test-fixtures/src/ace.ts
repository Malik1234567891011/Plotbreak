...
const raw = {
  ...
  items: [
    ...
    },
    {
      ...
      loreText:
        'The famous version of this exists because three boys decided it should, in a treehouse, with no adult present. It happens only if the three of them have earned it — a ceremony performed because it was expected is worth nothing — and a run that never reaches it has not missed anything. It has a different family.',
      icon: null,
    },
    {
      id: 'mera_mera',
      ...
      loreText:
        'Eat it and you are fire and can never swim again. Give it to Deuce and he is, and your crew is built around somebody else. Sell it and you have bought a ship, a reputation and a very persistent set of enemies. Leave it in the crate and Fire Fist Ace simply never exists, and nothing will offer you a second one.',
      icon: null,
    },
    {
      id: 'orange_hat',
    ...
    },
    {
      ...
      loreText:
        'Deuce writes down what actually happened, which turns out to be the rarest service anybody ever performs for him. Everyone else keeping a record is building a legend or a case file. He knew Ace before there was a legend, and this book is the only surviving copy of that man.',
      icon: null,
    },
    {
      id: 'whitebeard_mark',
    ...
    },
    {
      ...
      loreText:
        'Confirmation, which he has spent his whole life not asking for, because asking would have been confirming. Twenty months is written in here, in somebody’s official hand, as a medical irregularity. He will not know what to do with twenty months.',
      icon: null,
    },
    {
      id: 'seastone_cuffs',
  ...
  abilities: [
    ...
    },
    {
      ...
      description: 'Put himself physically in the path of something aimed at somebody else. He is superb at this, and it costs him nothing he values, which is precisely the problem.',
    ...
    },
    {
      id: 'ab_test_him',
      name: 'Keep Up, Then',
      tags: ['social', 'decision'],
      description: 'Throw him the spare pipe hard enough that catching it hurts, and then go up the ridge at the speed you would use alone.',
      affordances: ['make somebody earn it', 'accept without saying so'],
      costs: [{ resourceId: 'fuel', amount: 8 }],
      cooldownMinutes: 0,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    },
    {
      ...
      name: 'Go Home',
      tags: ['social', 'decision'],
      description: 'Say it plainly, without softening it, and keep walking. Not a threat — a decision, and he will still be there tomorrow.',
      affordances: ['refuse somebody', 'close a door and mean it'],
      costs: [{ resourceId: 'worth', amount: -3 }],
      cooldownMinutes: 0,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    {
      id: 'ab_take_the_uniform',
      name: 'Take Garp’s Offer',
      tags: ['decision', 'irreversible'],
      description: 'Go in the other direction, with the old man, into the organisation that executed your father.',
      affordances: ['leave by the other road'],
      costs: [],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
    ...
    {
      id: 'ab_stay_home',
      name: 'Not Get In The Boat',
      tags: ['decision'],
      description: 'Weigh the sea against a mountain with people on it, and pick the mountain. Not fear. A choice.',
      affordances: ['refuse the story'],
      costs: [],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
    ...
    },
    {
      ...
      name: 'Eat It',
      tags: ['decision', 'irreversible'],
      description: 'Bite into it, find out it tastes appalling, and never swim again.',
      affordances: ['become fire'],
      costs: [],
      cooldownMinutes: 0,
      targetRule: 'SELF',
      unlockedByDefault: true,
      requires: { flagsSet: ['inspected:mera_mera'] },
      tendencies: [],
      countersTendency: null,
    },
    {
      id: 'ab_hand_over_the_fruit',
      name: 'Give It Away',
      tags: ['decision', 'irreversible'],
      description: 'Put it in somebody else’s hands. Your crew has a Logia and it is not the captain, which changes every fight you will ever have.',
      affordances: ['give away the thing you were supposed to take'],
      costs: [],
      cooldownMinutes: 0,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
    ...
    {
      id: 'ab_sell_the_fruit',
      name: 'Sell It',
      tags: ['decision', 'irreversible'],
      description: 'Find out what a Logia fruit is worth, take the money, and buy something that floats.',
      affordances: ['convert a legend into a ship'],
      costs: [{ resourceId: 'notoriety', amount: 8 }],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
      requires: { flagsSet: ['inspected:mera_mera'] },
    ...
    },
    {
      ...
      description: 'Stop trading and end it, against somebody you have already been fighting. Available only to a man who has one left in him.',
      affordances: ['end a fight permanently'],
      costs: [{ resourceId: 'fuel', amount: 45 }],
      cooldownMinutes: 240,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    {
      id: 'ab_take_the_mark',
      name: 'Accept The Mark',
      tags: ['decision', 'irreversible'],
      description: 'Turn round, take your shirt off, and let somebody put a flag you did not design on a back you cannot see.',
      affordances: ['accept a family'],
      costs: [{ resourceId: 'pride', amount: -12 }, { resourceId: 'worth', amount: 15 }],
      cooldownMinutes: 0,
      targetRule: 'SELF',
      unlockedByDefault: true,
      requires: { flagsSet: ['challenged_whitebeard'] },
      tendencies: [],
      countersTendency: null,
    },
    {
      id: 'ab_refuse_the_mark',
      name: 'Stay Your Own Captain',
      tags: ['decision'],
      description: 'Decline, without insulting anybody, and keep your own name on your own flag.',
      affordances: ['refuse a family'],
      costs: [],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
    ...
    },
    {
      ...
      name: 'Go Alone',
      tags: ['decision', 'pride'],
      description: 'Be moving before anybody has finished the sentence, and tell nobody where.',
      affordances: ['answer for your own division', 'refuse to be carried'],
      costs: [{ resourceId: 'pride', amount: 12 }],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    {
      id: 'ab_take_them_with_you',
      name: 'Take A Team',
      tags: ['decision'],
      description: '"I am going. I am not going alone." Point at the commanders willing to come, and let them come.',
      affordances: ['ask for help out loud'],
      costs: [{ resourceId: 'pride', amount: -10 }],
      cooldownMinutes: 0,
      targetRule: 'MULTI',
      unlockedByDefault: true,
      tendencies: [],
    ...
    {
      id: 'ab_stand_down',
      name: 'Stop At The Rail',
      tags: ['decision', 'discipline'],
      description: 'Stop, and let the man who is asking give you the reason before pride makes the decision for you.',
      affordances: ['be talked out of it', 'hear somebody out'],
      costs: [{ resourceId: 'pride', amount: -18 }],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    },
    {
      ...
      name: 'Break Off',
      tags: ['decision'],
      description: 'Stop a fight you are losing and leave, while leaving is still something you can do.',
      affordances: ['retreat and live'],
      costs: [{ resourceId: 'pride', amount: -15 }, { resourceId: 'fuel', amount: 20 }],
      cooldownMinutes: 0,
      targetRule: 'SELF',
      unlockedByDefault: true,
      tendencies: [],
    ...
    },
    {
      ...
      name: 'Take His Hand',
      tags: ['decision', 'irreversible'],
      description: 'Accept the offer from the man who has just told you your own philosophy back more accurately than anybody ever has.',
      affordances: ['change sides'],
      costs: [],
      cooldownMinutes: 0,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
    ...
    {
      id: 'ab_turn_back',
      name: 'Say His Name Again',
      tags: ['decision', 'pride', 'irreversible'],
      description: 'Stop running. Turn round. Make him repeat what he said about the man who chose you.',
      affordances: ['answer an insult', 'close an argument'],
      costs: [{ resourceId: 'pride', amount: 20 }],
      cooldownMinutes: 0,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    },
    {
      ...
      name: 'Keep Moving',
      tags: ['decision', 'discipline'],
      description: 'Tighten your fists and keep going, because he did not come here so that you could win an argument.',
      affordances: ['let an insult stand', 'survive'],
      costs: [{ resourceId: 'pride', amount: -25 }],
      cooldownMinutes: 0,
      targetRule: 'SELF',
      unlockedByDefault: true,
      tendencies: [],
    ...
    {
      id: 'ab_let_them_carry_you',
      name: 'Let Them Take You',
      tags: ['decision', 'discipline'],
      description: 'Look at your brother once, and let somebody else make this decision, and go where you are taken.',
      affordances: ['accept being saved'],
      costs: [{ resourceId: 'pride', amount: -30 }, { resourceId: 'worth', amount: 20 }],
      cooldownMinutes: 0,
      targetRule: 'SELF',
      unlockedByDefault: true,
      tendencies: [],
    ...
    },
    {
      ...
      name: 'Laugh At Him',
      tags: ['decision', 'pride'],
      description: 'Keep running and grin over your shoulder. "You are trying too hard." It is not nothing, and it is not turning round.',
      affordances: ['refuse a provocation loudly'],
      costs: [{ resourceId: 'pride', amount: -8 }],
      cooldownMinutes: 0,
      targetRule: 'SINGLE',
      unlockedByDefault: true,
      tendencies: [],
    ...
    },
    {
      ...
      description: 'Portgas. Hers, chosen on purpose, said in full to people who were expecting the other one.',
      affordances: ['settle what your name is'],
      costs: [{ resourceId: 'worth', amount: 12 }],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
      requires: { flagsSet: ['knows_about_roger'] },
      tendencies: [],
      countersTendency: null,
    },
    {
      id: 'ab_say_it_all',
      name: 'Say The Whole Name',
      tags: ['decision', 'identity'],
      description: 'Gol D. Ace, out loud, where people can hear it, having worked out in advance exactly what that costs.',
      affordances: ['claim the thing used against you'],
      costs: [{ resourceId: 'notoriety', amount: 25 }],
      cooldownMinutes: 0,
      targetRule: 'NONE',
      unlockedByDefault: true,
      requires: { flagsSet: ['knows_about_roger'] },
  ...
  locations: [
    ...
    },
    {
      ...
      takeableItems: [
        { itemId: 'sake_cups', qty: 1, ownerId: null, aka: ['the cups', 'sake', 'a bottle', 'three cups'] },
    ...
    },
    {
      ...
      gates: [
        ...
        },
        {
          ...
          kind: 'TRUST',
          requires: { trust: 72, flagsSet: ['spoke:garp'] },
        },
      ],
      ...
      gates: [
        {
          ...
          kind: 'ALLIANCE',
          requires: { respect: 85, affection: 65, flagsSet: ['attacked:jinbe'] },
        },
      ],
      ...
      steps: [
        {
          ...
          succeedWhenAny: [
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_test_him', 'spoke:luffy'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_shut_him_out'] },
      ...
      steps: [
        {
          ...
          enterWhen: null,
          succeedWhen: { flagsSet: ['spoke:sabo'], minRelationship: [{ characterId: 'sabo', dimension: 'trust', value: 86 }] },
          succeedWhenAny: [],
          failWhen: null,
          deadlineWorldMinute: null,
          hiddenUntilEntered: false,
          rewards: { xp: 50, items: [], flags: ['knows_about_the_burning'] },
        },
        {
          id: 'q_sabo_sea',
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsUnset: ['visited:dawn_shore'], afterWorldMinute: 3000 },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['spoke:sabo'], atLocation: 'dawn_shore' },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['spoke:sabo'], atLocation: 'dawn_shore', hasItems: ['ship_fund'], minRelationship: [{ characterId: 'sabo', dimension: 'affection', value: 88 }] },
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { atLocation: 'dawn_shore', afterWorldMinute: 3600 },
            ...
            },
            {
              ...
              predicate: { atLocation: 'dawn_shore', flagsSet: ['asl_brotherhood'], minRelationship: [{ characterId: 'luffy', dimension: 'trust', value: 92 }] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_take_the_uniform'] },
            ...
            },
            {
              routeId: 'stayed',
              label: 'You do not go',
              predicate: { flagsSet: ['used:ab_stay_home'] },
          ...
          succeedWhenAny: [
            {
              routeId: 'eat',
              label: 'You eat it',
              predicate: { flagsSet: ['used:ab_eat_the_fruit'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_hand_over_the_fruit'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_sell_the_fruit'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['inspected:mera_mera'], hasItems: ['mera_mera'], afterWorldMinute: 6000 },
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['attacked:whitebeard'], atLocation: 'moby_dick_deck' },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['attacked:whitebeard', 'used:ab_finish_him'] },
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['used:ab_take_the_mark'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_refuse_the_mark'] },
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['used:ab_go_after_him'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_take_them_with_you'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_stand_down'] },
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['attacked:teach'], atLocation: 'banaro' },
            ...
            },
            {
              routeId: 'won',
              label: 'You finish it',
              predicate: { flagsSet: ['attacked:teach', 'used:ab_finish_him'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_break_off'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_take_his_hand'] },
      ...
      steps: [
        {
          ...
          enterWhen: null,
          succeedWhen: { flagsSet: ['spoke:garp'], atLocation: 'impel_down' },
          succeedWhenAny: [],
          failWhen: null,
          deadlineWorldMinute: null,
          hiddenUntilEntered: false,
        ...
        },
        {
          ...
          succeedWhen: { flagsSet: ['war_began'], atLocation: 'marineford_battlefield' },
          succeedWhenAny: [],
          failWhen: { flagsSet: ['used:ab_stand_between'], beforeWorldMinute: 140000 },
          deadlineWorldMinute: null,
          hiddenUntilEntered: true,
          rewards: { xp: 160, items: [], flags: ['ace_freed'] },
        },
        {
          id: 'q_mf_the_old_man',
          ...
          succeedWhenAny: [
            ...
            },
            {
              ...
              predicate: { flagsSet: ['war_began', 'accepted_being_saved'] },
              setsFlags: [],
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['used:ab_turn_back'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_keep_walking'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_let_them_carry_you'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_laugh_at_him'] },
      ...
      steps: [
        {
          ...
          succeedWhenAny: [
            ...
            },
            {
              ...
              predicate: { flagsSet: ['attacked:jinbe'] },
              setsFlags: ['learned_haki'],
              closesFlags: [],
            },
          ],
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['spoke:garp'], hasItems: ['roger_record'], minRelationship: [{ characterId: 'garp', dimension: 'trust', value: 80 }] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['spoke:shanks'], minRelationship: [{ characterId: 'shanks', dimension: 'trust', value: 55 }] },
              setsFlags: ['knows_about_roger'],
              closesFlags: [],
            },
          ],
          ...
          succeedWhenAny: [
            {
              ...
              predicate: { flagsSet: ['used:ab_use_her_name'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['used:ab_say_it_all'] },
            ...
            },
            {
              ...
              predicate: { flagsSet: ['knows_about_roger'], afterWorldMinute: 70000 },
  ...
  worldEvents: [
    ...
    {
      id: 'we_sabo_picked_up',
      atWorldMinute: 3300,
      locationId: null,
      publicCopy: '',
      directorNotes:
        'Silent, and the player never learns it. A ship with a different flag pulls a badly burned blond boy out of the water and he lives, without his memory and without anybody on Dawn Island being told. Ace believes him dead and is entitled to believe that for years — this event exists only so that a later reunion has something true behind it, and it must never be hinted at in prose the player can read.',
      setsFlags: ['sabo_taken_by_revolutionaries', 'sabo_alive'],
      cancelledByFlags: ['sabo_alive', 'stopped_sabo_sailing'],
      requiresFlags: ['sabo_dead'],
    },
    {
      id: 'we_execution_scheduled',
      atWorldMinute: 130000,
      locationId: 'impel_down',
      publicCopy: 'Somebody reads a date out to you through the bars, twice, because the first time you did not react.',
      directorNotes:
        'The World Government decides on a public execution. This is not about anything Ace has done — it is the demonstration they have wanted since before he was born, and the date is chosen for the press rather than for the law.',
      setsFlags: ['execution_scheduled'],
      cancelledByFlags: ['listened_to_whitebeard', 'retreated_from_teach', 'teach_defeated'],
      requiresFlags: ['ace_captured'],
    },
    {
      id: 'we_war_begins',
      atWorldMinute: 140000,
      locationId: 'marineford_platform',
      publicCopy: 'The bay is full of ships that are not Marine ships, and the oldest man in the world is standing on the deck of one of them.',
      directorNotes:
        'Whitebeard mobilises and the war starts. From here nothing is quiet again. Count the arrivals specifically — who came, which divisions, who came who was not asked — because every one of them is the answer to the question Ace has been carrying since he was eight and he is going to refuse to hear it.',
      setsFlags: ['war_began'],
      cancelledByFlags: [],
      requiresFlags: ['execution_scheduled'],
    },
  ],
  promises: [
    {
  ...
  endings: [
    ...
    },
    {
      ...
      rarity: 'COMMON',
      minTurn: 65,
      requires: { flagsSet: ['execution_scheduled'], flagsUnset: ['ace_freed', 'war_began'] },
  ...
  coverDirection: [
    ...
    'smiling and one frowning; a red beaded necklace; a bare chest in the character’s canonical design;',
    'black knee-length shorts; an orange belt with metal eyelets; a blue pouch strapped to the left thigh;',
    'a green-sheathed dagger at the hip.',
    ...
    'BEHIND HIM, layered and smaller but individually readable, two figures in the same anime style: one',
    'in a straw hat and a red vest to one side, one with blond hair under a black top hat with blue',
    'goggles to the other. Both drawn small, in the mid background, and identifiable by costume.',
